...
public class PersonalBoardTest {
    ...
    void testCalculateResourceItemObjective() {
        ...
        filledCorner2[0][0].setReference_card(card5);
        filledCorner2[0][1].setReference_card(card5);
        filledCorner2[1][0].setReference_card(card5);
        filledCorner2[1][1].setReference_card(card5);

        ResourceCard card9 = new ResourceCard(9, Orientation.FRONT, Color.GREEN, 1, filledCorner3);
        filledCorner3[0][0].setReference_card(card9);
        filledCorner3[0][1].setReference_card(card9);
        filledCorner3[1][0].setReference_card(card9);
        filledCorner3[1][1].setReference_card(card9);

        ResourceCard card10 = new ResourceCard(10, Orientation.FRONT, Color.GREEN, 1, filledCorner4);
        filledCorner4[0][0].setReference_card(card10);
        filledCorner4[0][1].setReference_card(card10);
        filledCorner4[1][0].setReference_card(card10);
        filledCorner4[1][1].setReference_card(card10);

        Corner[][] filledCorner0 = new Corner[2][2];
        for (int i = 0; i < 2; i++) {
            for (int j = 0; j < 2; j++) {
                filledCorner0[i][j] = new Corner(new BoardCellCoordinate(i, j));
                filledCorner0[i][j].setCornerResource(Resource.MUSHROOM);
            }
        }

        StarterCard starterCard = new StarterCard(0, Orientation.FRONT);
        starterCard.setStarterCardFront(Resource.LEAF, Resource.LEAF, Resource.LEAF, filledCorner0);

        personalBoard.placeStarterCard(starterCard);

        personalBoard.placeCardAtSE(starterCard, card2);
        personalBoard.placeCardAtSE(card2, card5);
        personalBoard.placeCardAtSE(card5, card9);
        personalBoard.placeCardAtSE(card9, card10);

        // After the placements, we have 3 mushrooms and 3 potions, 3 parchments and 4 feathers
        ...
        assertEquals(13, resourceObjectiveCard.calculateScore(personalBoard) +
