...
//    //------------------------game logic management------------------------
    ...
    public void testPlaceResourceCard() throws GameEndedException {
        ...
        gameModel.getCommonBoard().setInitialPosition();

        // Populate the table with cards from the decks
        for (int i = 0; i < 2; i++) {
            // Populate the first array with two cards from the Resource ConcreteDeck
            try {
                Card cardFromConcreteDeck1 = gameModel.getCommonBoard().getResourceConcreteDeck().pop();
                gameModel.getCommonBoard().getTableCards()[0][i] = cardFromConcreteDeck1;
            ...
            try {
                Card cardFromConcreteDeck2 = gameModel.getCommonBoard().getGoldConcreteDeck().pop();
                gameModel.getCommonBoard().getTableCards()[1][i] = cardFromConcreteDeck2;
            } catch (EmptyStackException e) {
                System.err.println("Empty deck: " + e.getMessage());
            }
            ...
            try {
                Card cardFromConcreteDeck3 = gameModel.getCommonBoard().getObjectiveConcreteDeck().pop();
                gameModel.getCommonBoard().getTableCards()[2][i] = cardFromConcreteDeck3;
            } catch (EmptyStackException e) {
                System.err.println("Empty deck: " + e.getMessage());
            }
        }
        gameModel.getCommonBoard().getDecks().add(0, this.gameModel.getCommonBoard().getResourceConcreteDeck());
        gameModel.getCommonBoard().getDecks().add(1, this.gameModel.getCommonBoard().getGoldConcreteDeck());
        gameModel.getCommonBoard().getDecks().add(2, this.gameModel.getCommonBoard().getObjectiveConcreteDeck());
        //**************************************************************************************
        ...
        assertEquals(1,gameModel.getAllPlayers().getFirst().getPersonalBoard().getBoard()[251][251].getLevel());
        ...
        gameModel.placeCard(gameModel.getAllPlayers().getFirst().getHand().get(1), gameModel.getAllPlayers().getFirst(), 251, 251);
        ...
        assertEquals(1,gameModel.getAllPlayers().getFirst().getPersonalBoard().getBoard()[250][250].getLevel());
        System.out.println(gameModel.getAllPlayers().getFirst().getPersonalBoard().getBoard()[250][250].getCornerFromCell().is_visible); //true
        System.out.println(gameModel.getAllPlayers().getFirst().getPersonalBoard().getBoard()[250][250].getCornerFromCell().getBoard_coordinate().getX());
        assertNotNull(gameModel.getAllPlayers().getFirst().getPersonalBoard().getBoard()[250][250].getCornerFromCell());
        System.out.println(gameModel.getAllPlayers().getFirst().getHand().get(1));
        ...
        gameModel.placeCard(gameModel.getAllPlayers().getFirst().getHand().get(1), gameModel.getAllPlayers().getFirst(), 251, 251);
        assertEquals(2,gameModel.getAllPlayers().getFirst().getPersonalBoard().getBoard()[251][251].getLevel());
        assertEquals(1,gameModel.getAllPlayers().getFirst().getPersonalBoard().getBoard()[251][252].getLevel());
        ...
        System.out.println(gameModel.getAllPlayers().getFirst().getPersonalBoard().getBoard()[251][252].getCornerFromCell().getCoordinate());
        System.out.println(gameModel.getAllPlayers().getFirst().getHand().get(1).getCornerAtNE().getCoordinate());
        System.out.println(gameModel.getAllPlayers().getFirst().getHand().size());
        ...
        gameModel.placeCard(gameModel.getAllPlayers().getFirst().getHand().get(0), gameModel.getAllPlayers().getFirst(), 251, 252);
        assertEquals(2,gameModel.getAllPlayers().getFirst().getPersonalBoard().getBoard()[251][252].getLevel());
        assertEquals(1,gameModel.getAllPlayers().getFirst().getPersonalBoard().getBoard()[252][252].getLevel());
        ...
        gameModel.placeCard((GoldCard) gameModel.getAllPlayers().getFirst().getHand().get(2), gameModel.getAllPlayers().getFirst(), 250, 250);
        ...
        assertEquals(2,gameModel.getAllPlayers().getFirst().getPersonalBoard().getBoard()[250][250].getLevel());
        System.out.println("*********");
