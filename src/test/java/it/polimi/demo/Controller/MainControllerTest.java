...
//        mainController.getGames().get(1).setPlayerAsConnected(p3);
        ...
        assertEquals(1,mainController.getGames().get(1).getModel().getAllPlayers().getFirst().getPersonalBoard().getBoard()[501][502].getLevel());
          ...
          assertEquals(1, mainController.getGames().get(1).getModel().getAllPlayers().getFirst().getPersonalBoard().getNum_butterflies());
          System.out.println(mainController.getGames().get(1).getModel().getAllPlayers().getFirst().getPersonalBoard().getBoard()[500][500].getCornerFromCell().resource);

        assertEquals(1, mainController.getGames().get(1).getModel().getAllPlayers().getFirst().getPersonalBoard().getNum_leaves());
        assertEquals(0, mainController.getGames().get(1).getModel().getAllPlayers().getFirst().getPersonalBoard().getNum_potions());
        ...
        mainController.getGames().get(1).getModel().getAllPlayers().getFirst().setChosenGameCard(mainController.getGames().get(1).getModel().getAllPlayers().getFirst().getHand().get(0));
        System.out.println(mainController.getGames().get(1).getModel().getAllPlayers().getFirst().getPersonalBoard().getBoard()[501][502].is_full);
        System.out.println(mainController.getGames().get(1).getModel().getAllPlayers().getFirst().getPersonalBoard().getBoard()[500][502].is_full);
        System.out.println(mainController.getGames().get(1).getModel().getAllPlayers().getFirst().getPersonalBoard().getBoard()[500][503].is_full);
        System.out.println(mainController.getGames().get(1).getModel().getAllPlayers().getFirst().getPersonalBoard().getBoard()[501][503].is_full);
        System.out.println(mainController.getGames().get(1).getModel().getAllPlayers().getFirst().getHand().get(0).getBack().getCornerAtNE());
        System.out.println(mainController.getGames().get(1).getModel().getAllPlayers().getFirst().getHand().get(0).getCornerAtNE());
        mainController.getGames().get(1).placeCard(mainController.getGames().get(1).getModel().getAllPlayers().getFirst(), 501, 502, Orientation.FRONT);
        ...
        mainController.getGames().get(1).getModel().getAllPlayers().getFirst().setChosenGameCard(mainController.getGames().get(1).getModel().getAllPlayers().getFirst().getHand().get(0));
        assertThrows(RemoteException.class, ()->mainController.getGames().get(1).placeCard(mainController.getGames().get(1).getModel().getAllPlayers().getFirst(), 500, 500, Orientation.FRONT));
        assertEquals(1,mainController.getGames().get(1).getModel().getAllPlayers().getFirst().getPersonalBoard().getBoard()[502][501].getLevel());
        ...
        // GoldCard on ResourceCard
        mainController.getGames().get(1).getModel().getAllPlayers().getFirst().setChosenGameCard(mainController.getGames().get(1).getModel().getAllPlayers().getFirst().getHand().get(0));
        assertThrows(RemoteException.class, ()->mainController.getGames().get(1).placeCard(mainController.getGames().get(1).getModel().getAllPlayers().getFirst(), 501, 503, Orientation.FRONT));

        assertEquals(1,mainController.getGames().get(1).getModel().getAllPlayers().getFirst().getPersonalBoard().getBoard()[501][503].getLevel());

        // GoldCard on GoldCard
        mainController.getGames().get(1).getModel().getAllPlayers().getFirst().setChosenGameCard(mainController.getGames().get(1).getModel().getAllPlayers().getFirst().getHand().get(0));
        assertThrows(RemoteException.class, ()->mainController.getGames().get(1).placeCard(mainController.getGames().get(1).getModel().getAllPlayers().getFirst(), 501, 504, Orientation.FRONT));
