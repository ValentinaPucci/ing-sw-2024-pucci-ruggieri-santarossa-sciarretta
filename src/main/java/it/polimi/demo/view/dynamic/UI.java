...
public abstract class UI {
    ...
    public List<String> relevant_facts; // gameFacts that needs to be showed always in screen
     ...
     */
    public abstract void show_options();
     ...
     */
    public abstract void show_createGame(String nickname);
     ...
     */
    public abstract void show_joinRandom(String nickname);
     ...
     * @param nickname The nickname of the player who joined the game.
     */
    public abstract void show_join(int idGame, String nickname);

    /**
     * Shows a prompt to insert the game ID.
     */
    public abstract void show_insertGameId();

    /**
     * Shows a prompt to insert the nickname.
     */
    public abstract void show_insertNickname();

    /**
     * Shows a prompt to insert the number of players.
     */
    public abstract void show_insertNumOfPlayers();

    /**
     * Shows the message indicating the game has started.
     * @param model The model view containing game state information.
     */
    public abstract void show_gameStarted(ModelView model);
     ...
     */
    public abstract void show_readyToStart(ModelView gameModel, String nicknameofyou);
     ...
     * @param model The model view containing game state information.
     */
    public abstract void show_gameEnded(ModelView model);
     ...
     */
    public abstract void show_playerJoined(ModelView gameModel, String nick);

    /**
     * Shows the starter cards of the game.
     * @param gameModel The model view containing game state information.
     */
    public abstract void show_starterCards(ModelView gameModel);

    /**
     * Shows the objective cards of the game.
     * @param gameModel The model view containing game state information.
     */
    public abstract void show_objectiveCards(ModelView gameModel);
     ...
     * @param gameModel The model view containing game state information.
     */
    public abstract void show_personalBoard(String nick, ModelView gameModel);

    /**
     * Shows the common board of the game.
     * @param gameModel The model view containing game state information.
     */
    public abstract void show_commonBoard(ModelView gameModel);

    /**
     * Show the correct position of players' pawns
     */

    public abstract void show_pawnPositions(ModelView model);

    /**
     * Shows a message indicating the current player's turn has finished.
     */
    public abstract void show_myTurnIsFinished();
     ...
     */
    public abstract void show_playerHand(ModelView gameModel, String nickname);

    /**
     * Shows the personal objective card of the player.
     * @param gameModel The model view containing game state information.
     */
    public abstract void show_personalObjectiveCard(ModelView gameModel);
     ...
     * @param model The model view containing game state information.
     */
    public abstract void show_cardChosen(String nickname, ModelView model);

    /**
     * Shows a message indicating an illegal move.
     */
    public abstract void show_illegalMove();

    /**
     * Shows a message indicating an illegal move due to a specific reason.
     * @param message The reason for the illegal move.
     */
    public abstract void show_illegalMoveBecauseOf(String message);
     ...
     */
    public abstract void show_successfulMove(Coordinate coord);

    /**
     * Shows a prompt indicating where to draw a card from.
     */
    public abstract void show_whereToDrawFrom();
     ...
     */
    public abstract void show_messageSent(ModelView model, String nickname);
     ...
     */
    public abstract void show_invalidInput();
     ...
     */
    public abstract void show_orientation(String message);

    /**
     * Shows a generic message.
     * @param s The message to show.
     */
    public abstract void show_genericMessage(String s);

    /**
     * Shows a generic error message.
     * @param s The error message to show.
     */
    public abstract void show_genericError(String s);
     ...
     */
    public abstract void clearRelevantGameFacts();
     ...
     */
    public abstract void show_nextTurn(ModelView model, String nickname);
     ...
     */
    public abstract void show_cardDrawn(ModelView model,String nickname);
     ...
     */
    public abstract void show_othersPersonalBoard(ModelView modelView, int playerIndex);
}
