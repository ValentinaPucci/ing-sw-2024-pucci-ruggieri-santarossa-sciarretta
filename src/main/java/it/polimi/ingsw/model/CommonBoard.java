...
public class CommonBoard {
    ...
    public CommonBoard(CardsCollection resource_cards, CardsCollection gold_cards, CardsCollection objective_cards,
                       String resource_path, String gold_path, String objective_path,
                       String resource_type, String gold_type, String objective_type) {
        resource_concrete_deck = new ConcreteDeck(resource_cards, resource_path, resource_type); //resource_concrete_deck
        gold_concrete_deck = new ConcreteDeck(gold_cards, gold_path, gold_type); //gold_concrete_deck
        objective_concrete_deck = new ConcreteDeck(objective_cards, objective_path, objective_type); //objective_concrete_deck
